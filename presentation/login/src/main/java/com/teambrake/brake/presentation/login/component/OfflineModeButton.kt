...
@Composable
internal fun OfflineModeButton(
	...
	Button(
		...
		Row(
			...
			Box(
				...
				Icon(
					painter = painterResource(id = R.drawable.ic_brake_offline),
					contentDescription = "Brake 로고",
			...
			Box(
				...
				Text(
					text = stringResource(R.string.offline_mode_button_text),
...
@Preview
@Composable
private fun OfflineModeButtonPreview(
